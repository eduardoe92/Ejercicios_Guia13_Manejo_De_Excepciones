 ...
 * puedan planear sus vacaciones de acuerdo con sus posibilidades.
 *
 * Los alojamientos se identifican por un nombre, una dirección, una localidad y
 * un gerente encargado del lugar.
 *
 * La compañía trabaja con dos tipos de alojamientos: Hoteles y Alojamientos
 * Extrahoteleros.
 *
 ...
 * Habitaciones.
 *
 * Los gimnasios pueden ser clasificados por la empresa como de tipo “A” o de
 * tipo “B”, de acuerdo a las prestaciones observadas. Las limosinas están
 * disponibles para cualquier cliente, pero sujeto a disponibilidad, por lo que
 * cuanto más limosinas tenga el hotel, más caro será.
 *
 ...
 * por limosinas).
 *
 * Donde: Valor agregado por el restaurante:
 *
...
public class Guia13Ejercicio1 {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Alojamiento> array = new ArrayList();
        Hoteles a2 = new Hoteles();
        Hoteles[] vector = new Hoteles[3];
...
//        }
//        
        a2.llenarAlojamiento();
        try {
            a2.llenarHotel();
            array.add(a2);    
        } catch (InputMismatchException e) {
            System.out.println("El número de habitaciones debe ser un entero");
            //System.out.println(e.getMessage());
        } finally {
            System.out.println("Llegamos hasta acá");
        }
